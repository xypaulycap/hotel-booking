...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:p4b-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            {bookings.map((booking)=> (
                <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t' >
                    ...
                    <div className='flex flex-row md:items-center md:gap-12 mt-3 gap-8'>
                        <div>
                            ...
                            <p className='text-gray-500 text-sm'>
                                {new Date(booking.checkInDate).toDateString('en-US', {
                                    year: 'numeric',
                                    month: '2-digit',
                                    day: '2-digit'
                                })}
                        ...
                        <div>
                            <p>Check Out:</p>
                            <p className='text-gray-500 text-sm'>
                                {new Date(booking.checkOutDate).toDateString('en-US', {
                                    year: 'numeric',
                                    month: '2-digit',
                                    day: '2-digit'
                                })}
                    ...
                    <div className='flex flex-col items-start justify-center pt-3'>
                        ...
                        {!booking.isPaid && (
                            <button onClick={()=> handlePayments(booking._id)} className='px-4 py-1.5 mt-4 text-xs border border-gray-400 rounded-full hover:bg-gray-100 transition-all cursor-pointer'>Pay Now</button>
                        )}
                    </div>
                </div>
            ))}
