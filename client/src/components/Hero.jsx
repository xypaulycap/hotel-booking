...
const Hero = () => {
    ...
    const {navigate, axios, setSearchedCities, getToken,} = useAppContext()
    ...
    const onSearch = async (e) => {
        ...
        //api to save recent saved cities
        await axios.post('/api/user/store-recent-search', {recentSearchedCity:destination}, {headers: {
  ...
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
        ...
        <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalled luxury and comfort awaits at the world's most exclusive hotels and resorts. Start your journey today.</p>
